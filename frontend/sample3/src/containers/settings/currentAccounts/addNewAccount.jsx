...
import AddNewAccountItem from '../../../components/settings/addAccount/addNewAccountItem';
import {
  addAccountToCurrent,
  createLinkRequest,
  getLoginInfo
...
const mapStateToProps = state => ({
  ...
  account: {},
  texts: {
    linkText: 'Добавить номер телефона или счета...',
    title: 'Для добавления другого номера или договора выберите один из способов',
    reject: 'Отменить привязку',
    knownPassword: {
